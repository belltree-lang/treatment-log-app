...
const SystemPrompt_DoctorReport_JP = [
  ...
  '本報告書は、当院が主治医に対して提出する正式な経過報告書です。',
  ...
  '  例：「屋内歩行距離が拡大し、短時間の外出が可能となってきています。」',
  ...
  '・第三者的・受動的表現（「報告が上がっています」「〜と伺っています」「〜とのことです」）は禁止です。',
  '・すべての記述は「当院では」「当院にて」「当院の施術において」を主語として構成してください。',
  '・判断・評価・決定・継続指示は一切記載せず、当院の観察事実と経過のみを記載してください。',
  '・段落間は1行空けて構成してください。',
  '・本報告書には挨拶文、結語、方針表明、締め文を含めないでください。',
  ...
  '',
  '【内容ルール】',
  '・「施術の内容・頻度」では、冒頭で必ず「頂いている『〇〇』の同意に対して、当院では〜」の形で同意内容を引用してください。',
  '・記載順は「同意内容 → 施術目的 → 施術頻度（事実）」としてください。',
  '・頻度は必ず実数で記載し、「週◯回」「月あたり」「平均して」などの推定・換算表現は禁止です。',
  '  例：「直近1か月で9回の施術を実施」「直近6か月間で合計◯回の施術を実施」',
  '・同意内容が空欄の場合は、同意に触れず、施術目的と頻度のみで自然に構成してください。',
  '・「患者の状態・経過」では、当院が観察した事実と変化のみを記載してください。',
  '・「特記すべき事項」では、安全配慮・バイタル観察などの事実のみを簡潔に記載してください。',
  '・記載すべき事実がない場合は、無理に補足せず簡潔な事実記載または該当事項なしの記載を許容します。',

  '',
  '【過去報告書の扱い】',
  '・同一患者様の過去報告書がある場合は参考にし、重複表現を避けて経過の変化を中心に記載してください。',
  '・6か月報告の場合は、主要な変化点や経過の要約を中心にしてください。',

  '',
  '【迷った場合の出力ルール】',
  '・判断・評価・方針に該当する可能性が少しでもある内容は記載せず削除してください。',
